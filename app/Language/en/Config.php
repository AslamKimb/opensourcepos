...
return [
    ...
    "brand_color_invalid"                      => "{0} must be a valid hex color such as #2563eb.",
    "brand_favicon"                            => "Browser Icon",
    "brand_short_name"                         => "Short Brand Name",
    "brand_show_powered_by"                    => "Show Powered By",
    "brand_show_powered_by_help"               => "Show the upstream project credit in the footer.",
    "branding"                                 => "Branding",
    "branding_configuration"                   => "Runtime Branding",
    "bottom"                                    => "Bottom",
    "cash_button"                               => "",
    "cash_button_1"                             => "",
    "cash_button_2"                             => "",
    ...
    "config_action_note"                        => "Saves this section only.",
    "config_page_subtitle"                      => "Store, display, tax, print, locale, and system settings are grouped into focused sections.",
    "config_page_title"                         => "Configuration",
    "config_save_changes"                       => "Save Changes",
    "config_section"                            => "Settings",
    "config_section_barcode_help"               => "Barcode dimensions, label content, and output layout.",
    "config_section_branding_help"              => "Runtime app name, browser icon, footer credit, and color palette.",
    "config_section_general_help"               => "Application behavior, image limits, notification placement, and operational defaults.",
    "config_section_info_help"                  => "Store identity and contact details used on receipts, invoices, and documents.",
    "config_section_invoice_help"               => "Invoice numbering, print details, and invoice document behavior.",
    "config_section_locale_help"                => "Currency, number formatting, language, timezone, and date formats.",
    "config_section_receipt_help"               => "Receipt template, printer behavior, margins, and receipt content visibility.",
    "config_section_reward_help"                => "Customer reward program setup and reward values.",
    "config_section_stock_help"                 => "Stock location names available to inventory and receiving workflows.",
    "config_section_system_help"                => "System information, email, messaging, integrations, and license details.",
    "config_section_table_help"                 => "Dinner table feature setup and table names.",
    "config_section_tax_help"                   => "Tax identifiers, default tax rates, and jurisdiction settings.",
