...
class TopbarLayoutTest extends TestCase
{
	public function testHeaderUsesTopbarUtilityClassesWithoutInlineStyles(): void
	{
		...
		$this->assertStringContainsString('class="container topbar-row app-shellbar-row"', $header);
		$this->assertStringContainsString('class="navbar-right topbar-item topbar-actions app-shell-actions"', $header);
		$this->assertStringContainsString('class="topbar-item topbar-company app-shell-meta"', $header);
